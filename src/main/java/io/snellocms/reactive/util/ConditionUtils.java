...
import static io.snellocms.reactive.management.AppConstants.UUID;
import static io.snellocms.reactive.util.ParamUtils.*;
...
public class ConditionUtils {
    ...
    public static Map<String, Object> createCondition(Map<String, Object> map, ApiService apiService, String table,
                                                      Event eventPublisher) throws Exception {
